...
public class GameManager : MonoBehaviour
{
    ...
    private void StartGame()
    {
        ...
        //_level.GetComponent<Levels>().Construct(_level, _level.transform, _numberLevel, _isEndlessLevel);

        _player = new GameObject("Player"); _player.transform.parent = _game.transform;
        _player.AddComponent<PlayerBuilder>();
       // _player.GetComponent<PlayerBuilder>().Construct(_player, characterPocition);
    }
